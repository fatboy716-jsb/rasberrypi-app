...
class MainScreen(QMainWindow):
    ...
    def update_theme(self, dark_mode: bool):
        if dark_mode:
            for i in [self.ui.widget2,self.ui.widget3,self.ui.widget4,self.ui.widget5,self.ui.widget6,self.ui.label_1_1,self.ui.btnStop ]:
                i.setStyleSheet("""
            ...
            for i in [self.ui.widget2, self.ui.widget3, self.ui.widget4, self.ui.widget5, self.ui.widget6,
                      self.ui.label_1_1, self.ui.btnStop]:
